...
function animate() {
  ...
  tl1.set(['#copy1', '#copy2', '#copy3', '#copy4', '#text-img', '#cta', '#logo', '#product'], { autoAlpha: 0 });
  tl1.set(['#product'], { y: '+=10' });

  tl1.to(['#logo-1'], 0.5,{ autoAlpha: 1, x: '+=0', width: '+=0.65', rotationY: 0.1 }, 0.5);
  tl1.to(['#logo-2'], 0.5,{ autoAlpha: 1, x: '+=2.5', width: '+=1.3', rotationY: 0.1 }, 1);
  tl1.to(['#logo-3'], 0.5,{ autoAlpha: 1, x: '+=5', width: '+=2.3', rotationY: 0.1 }, 0.75);
  tl1.to(['#logo-4'], 0.5,{ autoAlpha: 1, x: '+=7.75', width: '+=16.75', rotationY: 0.1 }, 0.5);
  ...
  tl1.to(['#product'], 0.5,{ autoAlpha: 1, y: '-=10', scale: 1 }, '+=0.5');
  tl1.to(['#copy1', '#text-img', '#sparkles1', '#sparkles2', '#sparkles3'], 0.5,{ autoAlpha: 0 }, '+=2');
...
function addSparkles(div) {
  ...
  for (var i = 0; i < sparkleCount; i++) {
    ...
    sparkle.style.top = randomNum(2, 52) +'px';
    sparkle.style.left = randomNum(20, 245) +'px';
