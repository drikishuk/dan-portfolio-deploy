...
function animate() {
  ...
  tl.set(["#photo2"], { x:728-60});

  tl.addLabel('frame_1', 0)

  .to('#photo', 3.5, { x:"-=60",  ease:"none" }, "frame_1")
  ...
  .to(['#h1'], 0.5, {  autoAlpha: 0, ease: Power1.easeInOut }, "-=1")
  .to(['#h1b, #h2'], 0.5, {  autoAlpha: 1, ease: Power1.easeInOut }, "+=.1")
