...
function animate() {
  ...
  tl1.to('#logo-1', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '+=2');
  tl1.to('#text-1', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');
  
  tl1.to('#text-1', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '+=2');
  tl1.to('#text-2', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');

  tl1.to('#text-2', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '+=2');
  tl1.to('#text-3', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');

  tl1.to('#text-3', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '+=2');
  tl1.to(['#logo-2', '#tier'], 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');
  tl1.to(['#brand_cta_outer', '#text-legal'], 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');

  tl2.to('#bg', 10,{ scale: 1, ease: "power1.out" }, 0);
}
