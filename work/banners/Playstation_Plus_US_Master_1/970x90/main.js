...
function animate() {
  ...
  tl1.to('.main-image', 1,{ x: '-=500', ease: "power4.out" }, '+=2');
  tl1.to('#text-2', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '<');
  tl1.to(['#logo-2', '#tier'], 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');
  ...
  tl2.to('#bg-3', 1,{ x: '+=700', ease: "power1.out" }, 0);
  tl2.to('#bg-4', 1,{ x: '+=900', ease: "power1.out" }, 0);
  tl2.to('#bg-5', 1,{ x: '+=1100', ease: "power1.out" }, 0);
  tl2.to(['#bg-2', '#bg-3', '#bg-4'], 11,{ x: '+=75', ease: "none" }, '+=0');
}
