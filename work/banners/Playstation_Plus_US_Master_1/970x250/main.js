...
function animate() {
  ...
  tl1.to('#image-1', 1,{ x: '+=500', ease: "power1.out" }, 0);
  tl1.to('#logo-1', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '-=0.3');

  tl1.to('#image-2', 1,{ x: '+=500', ease: "power4.out" }, '+=2');
  tl1.to('#logo-1', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '<');
  tl1.to('#text-1', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '-=0.6');
  tl1.to('#image-1', 0,{ autoAlpha: 0, ease: "power1.out" }, '+=0');
  
  tl1.to('#image-3', 1,{ x: '+=500', ease: "power4.out" }, '+=2');
  ...
  tl1.to('#image-4', 1,{ x: '+=500', ease: "power4.out" }, '+=2');
  tl1.to('#text-2', 0.5,{ autoAlpha: 0, ease: "power1.out" }, '<');
  tl1.to(['#logo-2', '#tier'], 0.5,{ autoAlpha: 1, ease: "power1.out" }, '-=0.6');
  tl1.to('#image-3', 0,{ autoAlpha: 0, ease: "power1.out" }, '+=0');
  tl1.to('#text-3', 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');
  tl1.to(['#brand_cta_outer', '#text-legal'], 0.5,{ autoAlpha: 1, ease: "power1.out" }, '+=0');

  tl2.to('#bg-2', 1,{ x: '+=500', ease: "power1.out" }, 0);
  tl2.to('#bg-3', 1,{ x: '+=800', ease: "power1.out" }, 0);
  tl2.to('#bg-4', 1,{ x: '+=1050', ease: "power1.out" }, 0);
  tl2.to(['#bg-2', '#bg-3'], 11,{ x: '+=75', ease: "none" }, '+=0');
}
