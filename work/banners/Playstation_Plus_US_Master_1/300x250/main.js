...
function animate() {
  ...
  tl1.to('#image-3', 1,{ x: '-=300', ease: "power4.out" }, '+=2');
  ...
  tl2.to('#bg-2', 1,{ x: '-=300', ease: "power1.out" }, 0);
  tl2.to('#bg-3', 1,{ x: '-=360', ease: "power1.out" }, 0);
  tl2.to('#bg-4', 1,{ x: '-=420', ease: "power1.out" }, 0);
  tl2.to('#bg-5', 1,{ y: '-=480', ease: "power1.out" }, 0);
  tl2.to('#bg-6', 1,{ y: '-=540', ease: "power1.out" }, 0);
  tl2.to(['#bg-2', '#bg-3', '#bg-4', '#bg-5'], 11,{ x: '-=30', ease: "none" }, '+=0');
}
