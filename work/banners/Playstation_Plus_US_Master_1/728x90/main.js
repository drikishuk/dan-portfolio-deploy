...
function animate() {
  ...
  tl2.to('#bg-3', 1,{ x: '+=680', ease: "power1.out" }, 0);
  tl2.to('#bg-4', 1,{ x: '+=860', ease: "power1.out" }, 0);
  tl2.to('#bg-5', 1,{ x: '+=1040', ease: "power1.out" }, 0);
  tl2.to(['#bg-2', '#bg-3', '#bg-4'], 11,{ x: '+=45', ease: "none" }, '+=0');
}
