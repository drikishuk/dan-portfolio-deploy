...
function animate() {
  ...
  tl.to("#animation", 0.5, { autoAlpha: 1, ease: Power1.easeOut }, "<")

  tl.to(["#text2", "#animation"], 0.5, { autoAlpha: 0, ease: Power1.easeOut }, "+=2")
  tl.to(["#text3", "#text4", "#text5", "#cta"], 0.5, { autoAlpha: 1, ease: Power1.easeOut }, "+=0")
...
function default_over(event) {
  TweenMax.to(["#cta"], 0.3, { scale: 1.1, ease: Power1.easeOut, delay: 0, backgroundColor:"#fff" });
}
