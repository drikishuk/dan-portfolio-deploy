...
function init() {
  ...
  .set("#brand_cta_outer", { opacity: 0 })
    ...
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, 2.5)
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.45,{ x: '+=150', ease: "power2.inOut" }, '<')
    
    tl_banner2.to(['#game-2', '#game-5'], 0.45,{ x: '-=75', ease: "power2.inOut" }, '<')
    tl_banner2.to(['#game-2', '#game-5'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '<')
    
    tl_banner2.to(['#game-3', '#game-6'], 0.45,{ x: '-=75', ease: "power2.inOut" }, '<')
    ...
    tl_banner2.to(['#game-2', '#game-5'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '+=0.9')
    tl_banner2.to(['#game-2', '#game-5'], 0.45,{ x: '+=150', ease: "power2.inOut" }, '<')
    
    tl_banner2.to(['#game-3', '#game-6'], 0.45,{ x: '-=75', ease: "power2.inOut" }, '<')
    tl_banner2.to(['#game-3', '#game-6'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '<')
    
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.45,{ x: '-=75', ease: "power2.inOut" }, '<')
    ...
    tl_banner2.to(['#text-2'], 0.5,{autoAlpha: 1 }, '+=0')
    ...
    tl_banner2.to(['#game-3', '#game-6'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '+=0.9')
    tl_banner2.to(['#game-3', '#game-6'], 0.45,{ x: '+=150', ease: "power2.inOut" }, '<')
    
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.45,{ x: '-=75', ease: "power2.inOut" }, '<')
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '<')
    ...
    tl_banner2.to(['#text-2'], 0.5,{autoAlpha: 0 }, '-=0.75')
    tl_banner2.to(['#features'], 0.5,{autoAlpha: 1 }, '+=0')
    ...
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.35,{ scale: 0.87, ease: "power2.inOut" }, '+=0.9')
    tl_banner2.to(['#game-1', '#game-4', '#game-7'], 0.45,{ x: '+=150', ease: "power2.inOut" }, '<')
  ...
  tl_banner2.to(['#features'], 0.5,{autoAlpha: 0 }, '-=0.75')
  tl_banner2.to(['#tabs-text', '#tabs'], 0.5,{autoAlpha: 1 }, '+=0')
