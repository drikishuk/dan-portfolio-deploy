...
function createTimeline() {
	...
	tl
		...
		.addLabel("frame1", 4)
		.to(text1, {duration:0.5, autoAlpha:0}, "frame1")
		.from(frame1Legal, {duration:0.5, autoAlpha:0}, "frame1+=0.5")
		.to(myClip1.children, {duration: 0.5, x: -bannerWidth, ease: Power2.easeInOut, stagger:0.2, onUpdate: () => redrawClipPath(".clip-svg", "myClip1")}, "frame1+=3")


		.addLabel("frame2", 9)
		.to(frame2bg, {duration:10, scale:1.1, ease:"linear"}, "frame2-=4")
		.to(text2, {duration:0.5, autoAlpha:0}, "frame2")
		.from(frame2Legal, {duration:0.5, autoAlpha:0}, "frame2+=0.5")
		.to(myClip2.children, {duration: 0.5, x: -bannerWidth, ease: Power2.easeInOut, stagger:0.2, onUpdate: () => redrawClipPath(".clip-svg2", "myClip2")}, "frame2+=3")
		...
		.to(text4, {duration:0.5, autoAlpha:0}, "frame4")
		.from(frame4Legal, {duration:0.5, autoAlpha:0}, "frame4+=0.5")
		.to(myClip4.children, {duration: 0.5, x: -bannerWidth, ease: Power2.easeInOut, stagger:0.2, onUpdate: () => redrawClipPath(".clip-svg4", "myClip4")}, "frame4+=3")


		.addLabel("frame5", 24)
		.to(frame5bg, {duration:10, scale:1.1, ease:"linear"}, "frame5-=4")
		.from(".copyLock", {duration:0.35, y:-17, ease:Quad.easeIn}, "frame5-=2")
		.set([by, brit], {autoAlpha:1, stagger:0.2}, "frame5-=1.65")
		.to(".copyLock", {duration:0.35, y:"+23", ease:Quad.easeIn}, "frame5-=1.1")
		.to(".copyLock", {duration:0.35, y:"+47", ease:Quad.easeIn}, "frame5")
		.to(britLockup, {duration:0.5, autoAlpha:0}, "frame5+=1")
		.from(frame5Legal, {duration:0.5, autoAlpha:0}, "frame5+=1.5")
		.to(frame5Legal, {duration:0.5, autoAlpha:0}, "frame5+=3")
		.from(cta, {duration:0.5, autoAlpha:0}, "frame5+=3.5")
