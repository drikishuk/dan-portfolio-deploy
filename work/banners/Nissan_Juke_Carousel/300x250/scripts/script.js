...
function createTimeline() {
    ...
    tl  .call(function(paused) {
		...
		.set([by, brit], {autoAlpha:0, y:-10})
		.set([text2, text3, text4], {y:20})
		...
		.from(".copyLock", {duration:0.35, y:-35, ease:Quad.easeIn}, "frame5-=2")
		.set([by, brit], {autoAlpha:1, stagger:0.2}, "frame5-=1.65")
		.to(".copyLock", {duration:0.35, y:"+38", ease:Quad.easeIn}, "frame5-=1.1")
