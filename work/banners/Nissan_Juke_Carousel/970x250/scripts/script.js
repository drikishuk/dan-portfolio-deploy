...
function createTimeline() {
    ...
    tl  .call(function(paused) {
		...
		.from(".copyLock", {duration:0.35, y:-50, ease:Quad.easeIn}, "frame5-=2")
		.set([by, brit], {autoAlpha:1, stagger:0.2}, "frame5-=1.65")
		.to(".copyLock", {duration:0.35, y:"+46", ease:Quad.easeIn}, "frame5-=1.1")
		.to(".copyLock", {duration:0.35, y:"+93", ease:Quad.easeIn}, "frame5")
