...
function init() {
  ...
  tl2 = new TimelineMax({ repeat: 50, delay: 0.25 });
...
function animate() {
  ...
  tl.set(["#main_content"], { autoAlpha: 1, force3D: true })
    ...
    .set("#text2", { x: 200 })
    .set(["#text2", "#text3", "#cta", "#terms", "#info", "#close", "#etf"], { autoAlpha: 0})

  tl.to(["#text1"], 5,{y: -700, ease: textEase}, 0.5)
    .to(["#text2"], 0.4,{ autoAlpha: 1, x: 0,  ease: Power1.easeInOut }, 1.5)
    .to(["#text1", "#text2"], 0.5,{autoAlpha: 0, ease: Power1.easeOut}, 5)
    .to(["#text3", "#cta", "#etf"], 0.4,{ autoAlpha: 1, ease: Power1.easeInOut }, ">")
    ...
    .to(["#terms"], 0.1,{ y: 90, ease: Power1.easeInOut }, "<")
...
function hideTerms(event) {
  TweenMax.to(["#terms"], 0.6, { y: 90, ease: easing, delay: 0 });
}
