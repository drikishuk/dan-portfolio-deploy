...
function animate() {
  ...
  tl.to(["#text1"], 5,{y: -1600, ease: textEase}, 0.5)
    ...
    .to(["#terms"], 0.1,{ y: 600, ease: Power1.easeInOut }, "<")
...
function hideTerms(event) {
  TweenMax.to(["#terms"], 0.6, { y: 600, ease: easing, delay: 0 });
}
