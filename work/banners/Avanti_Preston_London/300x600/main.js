...
function animate() {
  ...
  tl1.staggerTo('.animate', 1,{ autoAlpha: 1 }, 1, 0.5);

  tl1.to(['#bg', '#orange-line', '.animate'], 12.5,{ y: '-=538', x: '-=196', rotation: 0.1, ease: "power4.in" }, 2.5);

  tl2.to(['#train'], 12.5,{ y: '+=80', x: '+=29' }, 2.5);
  tl2.to(['#logo', '#cta'], 1,{ autoAlpha: 1 }, 12);
}
