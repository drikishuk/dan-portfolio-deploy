...
function animate() {
  ...
  tl1.to(['#bg', '#orange-line', '.animate'], 12.5,{ y: '-=451', x: '-=164', rotation: 0.1, ease: "power4.in" }, 2.5);

  tl2.to(['#txt8'], 1,{ autoAlpha: 0 }, 12);
  tl2.to(['#txt9'], 1,{ autoAlpha: 1 }, '+=0.5');
  tl2.to(['#logo', '#cta'], 1,{ autoAlpha: 1 }, '+=0.5');
}
