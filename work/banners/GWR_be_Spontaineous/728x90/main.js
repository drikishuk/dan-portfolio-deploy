...
function doAnimation() {
  ...
  tl.staggerTo('.text-1', 0.5, { autoAlpha: 1, y: '-=12', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-2', 0.5, { autoAlpha: 1, y: '-=12', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-3', 0.5, { autoAlpha: 1, y: '-=12', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.to('#text-4b', 0.5, { autoAlpha: 1, x: '-=41', ease: "power1.out" }, '-=0.25');
  tl.to('#text-4c', 0.5, { autoAlpha: 1, scale: 1.4, ease: "power1.inOut" }, '-=0.5');
  tl.to('#text-4d', 0.5, { autoAlpha: 1, x: '+=51', ease: "power1.inOut" }, '-=0.5');

  tl.to('#text-4b', 0.5, { autoAlpha: 1, x: '+=26', ease: "power1.out" }, '+=0');
  tl.to('#text-4c', 0.5, { autoAlpha: 1, scale: 1, y: '-=4', ease: "power1.inOut" }, '-=0.5');
  tl.to('#text-4d', 0.5, { autoAlpha: 1, x: '-=32', ease: "power1.inOut" }, '-=0.5');
