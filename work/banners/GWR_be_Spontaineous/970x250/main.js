...
function doAnimation() {
  ...
  tl.staggerTo('.text-1', 0.5, { autoAlpha: 1, y: '-=19', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-2', 0.5, { autoAlpha: 1, y: '-=19', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-3', 0.5, { autoAlpha: 1, y: '-=19', ease: "power1.out" }, 0.125, '+=0');
