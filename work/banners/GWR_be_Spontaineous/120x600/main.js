...
function doAnimation() {
  ...
  tl2.to('#bg-2', 10, { transform: "translate3d(0, 0, 0) scale(1.1)" }, 4)

  tl.to('#main_content', 0.5, { autoAlpha: 1, ease: "power1.out" }, 0);
  tl.staggerTo('.text-1', 0.5, { autoAlpha: 1, y: '-=10', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-2', 0.5, { autoAlpha: 1, y: '-=10', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.staggerTo('.text-3', 0.5, { autoAlpha: 1, y: '-=10', ease: "power1.out" }, 0.125, '+=0');
  ...
  tl.to('#text-4b', 0.5, { autoAlpha: 1, y: '+=3', x: '-=20', ease: "power1.out" }, '-=0.25');
  tl.to('#text-4c', 0.5, { autoAlpha: 1, scale: 1.4, ease: "power1.inOut" }, '-=0.5');
  tl.to('#text-4d', 0.5, { autoAlpha: 1, y: '+=3', x: '+=22', ease: "power1.inOut" }, '-=0.5');

  tl.to('#text-4b', 0.5, { autoAlpha: 1, y: '-=3', x: '+=13', ease: "power1.out" }, '+=0');
  tl.to('#text-4c', 0.5, { autoAlpha: 1, scale: 1, y: '-=3', ease: "power1.inOut" }, '-=0.5');
  tl.to('#text-4d', 0.5, { autoAlpha: 1, y: '-=3', x: '-=13', ease: "power1.inOut" }, '-=0.5');
